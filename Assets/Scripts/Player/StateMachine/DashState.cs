...
public class DashState : PlayerBaseState
{
    ...
    { 
        ...
        BuffsManager.Instance.GetBuff(GameEnums.EBuffs.Shield).gameObject.layer = LayerMask.NameToLayer(GameConstants.SHIELD_LAYER);
    ...
    private void HandleDash()
    {
        ...
        BuffsManager.Instance.GetBuff(GameEnums.EBuffs.Shield).gameObject.layer = LayerMask.NameToLayer(GameConstants.IGNORE_ENEMIES_LAYER);
